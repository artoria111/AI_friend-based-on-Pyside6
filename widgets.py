...
class FloatingBubble(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.btn_voice.setFixedSize(38, 38)
        ...
        """
        self.btn_voice.setStyleSheet(VOICE_BTN_QSS)
    ...
    def show_text(self, ai_text, user_text=None):
        ...
        final_width = min(max(user_width, ai_width, 220), 360)
